---
name: admin-crud-new-module-checklist
...
Rules detalhadas: `admin-crud-module-structure`, `admin-crud-search-params`, `admin-crud-actions-api`, `admin-crud-composition-ui`, `admin-crud-formularies`, `admin-crud-media-upload`.
