...
Rules: `estrutura-pastas-rotas`, `search-params-url`, `modals-url`, `actions-api`, `tanstack-query`, `composition-ui`, `formularies`, `zustand-stores`, `use-confirm`, `env-zod`, `interfaces-base`, `api-auth`.
