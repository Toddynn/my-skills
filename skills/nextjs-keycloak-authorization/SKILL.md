---
name: nextjs-keycloak-authorization
...
Login humano = Authorization Code. M2M e Admin REST = skill `keycloak-admin-rest`.
...
CRUD de administradores Keycloak (promover user, copiar roles) **não** é login — skill `keycloak-admin-rest`.
